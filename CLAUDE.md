...
| `dev_edgar_annual_series` | `edgar_annual_series_collection` | EDGAR-Jahresreihen für die Stetigkeits-Dimension. Nur der Extrakt, nie companyfacts roh. **Cache gebaut, noch nicht im Monatslauf verdrahtet** (Spec-Schritte 4–5 offen) | **cik** | 400 d ± 60 d Jitter; Negativ 60 d ohne Jitter | nein — Backfill statt Purge; Schema-Version invalidiert |
