...
- Detail-Historie je Teilstufe: `## Erledigt`. Nächste Arbeit: 2a.1b (Sterne-Kalibration, klein) vs. Punkt 5 (Filing-Parser, groß) — Reihenfolge offen, siehe Backlog.
...
**Offen (Reihenfolge in Klärung, Default-Vorschlag 2026-05-20: 2a.1b → 5 → 2a.2 → 2a.3 → B.2):**

- [ ] **2a.1b — Sterne-Inflation-Fix** *(neu nach 2a.1-Verifikation)* — Prompt-Diff für Sterne-Kalibration: harter Max-Cap 5×⭐⭐⭐⭐⭐ + Begründungs-Pflicht bei Top-Note. Klein, gleiche Pipeline-Schicht wie 2a.1. Befund-Auslöser: GOOGL und ASML zeigten je 6/15 ⭐⭐⭐⭐⭐, bei ASML mit 13/15 Inferenz-only-Punkten definitiv falsch kalibriert.
- [ ] **5. Filing-Parser-Mehrfach-Anker** *(vorgezogen)* — Item 4/5/18 „N candidate anchors". Empirisch dringender als ursprünglich angenommen: ASML-Verifikations-Lauf zeigte Item 4/5 **missing**, Item 18 truncated → 13/15 Punkte auf `[Inferenz]`, Memo investment-untauglich. Solange ungelöst sind alle EU-Filing-Tool-B-Läufe (20-F) inhaltlich unbrauchbar = großer Teil von STOXX 600 ausgeschlossen. Groß, eigene Diagnose-Runde.
...
**Beobachtungen aus 2a.1-Verifikations-Lauf (keine Aktion, getrackt):**

- ASML-Lauf: Punkt 5-Reasoning erfand Source-Marker `[peer_comparison]` — nicht im System-Prompt spezifiziert. Klein, Drift-Indikator, nicht reproduziert bei GOOGL. Beobachtung relevant für etwaige zukünftige Source-Format-Härtung.
