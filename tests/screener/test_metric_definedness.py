...
def test_real_waterfall_is_defined():
    ...
    v = classify_waterfall(
        total_revenue=1000.0,
        cost_of_revenue=300.0,
        gross_profit=700.0,
        cost_of_revenue_present=True,
    )
...
def test_assess_reit_is_metrik_na_without_statement():
    ...
    assert (
        ...
        is DefinednessOutcome.METRIK_NA
    )
...
def test_assess_fetch_failed_is_unassessable_not_metrik_na():
    ...
    assert (
        ...
        is DefinednessOutcome.UNASSESSABLE
    )
